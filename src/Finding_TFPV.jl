...
"""
function filter_dimension(problem::ReductionProblem; idx=nothing, compute_primary_decomposition::Bool=true, exact_dimension::Bool=true)
  ...
  return idx_candidates, (V, dim_components)
